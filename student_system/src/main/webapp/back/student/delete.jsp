...
font-style: italic;
    ...
    <div class="row">
        <div class="col-sm-12">
            <h1 class="text-center">学生信息删除</h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            <form class="form-horizontal" action="${pageContext.request.contextPath}/student/delete" method="post">
                <div class="form-group">
                    <label for="name" class="col-sm-2 control-label">姓名</label>
                    <div class="test">${name} </div>
                    <div class="col-sm-10">
                        <input type="hidden" name="name" class="form-control" id="name" placeholder="请输入学生姓名"
                               value="${name}"
                        >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="hidden" name="age" class="form-control" id="age" placeholder="请输入学生年龄"
                               value="${age}"
                        >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="test">${bir} </div>
                    <div class="col-sm-10">
                        <input type="hidden" name="bir" class="form-control" id="bir" placeholder="请输入生日"
                               value="${bir}"
                        >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="hidden" name="phone" class="form-control" id="phone" placeholder="请输入手机号码"
                               value="${phone}"
                        >
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="test">${qq} </div>
                    <div class="col-sm-10">
                        <input type="hidden" name="qq" class="form-control" id="qq" placeholder="请输入QQ号码"
                               value="${qq}"
                        >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="hidden" name="attr" class="form-control" id="attr" placeholder="请输入生肖"
                               value="${attr}"
                        >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="test">${starts} </div>
                    <div class="col-sm-10">
                        <input type="hidden" name="starts" class="form-control" id="starts" placeholder="请输入星座"
                               value="${starts}"
                        >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="hidden" name="mark" class="form-control" id="mark" placeholder="请输入星座"
                               value="${mark}"
                        >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 20px;">
                    <div class="col-sm-12 col-sm-offset-1">
                        <button type="submit" style="width: 45%" class="btn btn-info">确认删除</button>
